...
class Test09_AdminMessagesCest
{
    public function AdminMessagesTest(AcceptanceTester $I): void
    {
        ...
        $I->SeeInDatabase('messages', ['sender_id' => '1', 'receiver_id' => '3', 'title' => "Temat", 'message' => 'Treść']);
        ...
        $I->seeElement(['xpath' => "//select[@id='receiver_id']"]);
        $I->selectOption(['xpath' => "//select[@id='receiver_id']"], '1');
        ...
        $I->seeCurrentUrlEquals('/dashboard');
        $I->expect('See message in database');
        $I->SeeInDatabase('messages', ['sender_id' => '1', 'receiver_id' => '1', 'title' => 'Temat1', 'message' => 'Treść1']);

        $I->see('Otrzymane wiadomości');
        $I->see('Wiadomość od: admin adminski');
        $I->see('Temat1');
        $I->see('Treść1');

        $I->click("Wyczyść skrzynkę");
        $I->dontsee('Wiadomość od: admin adminski');
    }
}
